<template>
  <div class="navHeader">
    <span class="navHeader-item" href="#" @click.prevent.self="backMainView">Новости</span>
    <span
      href="#"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      ...mapMutations('menu', ['SET_BREADCRUMBS']),
      fetchData() {
        this.getBreadCrumbs();
      },
      clickEvent(item) {
      ...
      CheckLastItem(indexItem) {
        if (this.breadcrumbs.length > 0) {
          if (this.breadcrumbs.length - 1 == indexItem) return 'bold';
        }
