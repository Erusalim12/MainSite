<template>
  <div class="row" style="margin-top: 10px">
    ...
    <div class="flexCategoryList">
      <msCategoryItem v-for="item in getCategoryChildren" :key="item.Id" :category_item="item" />
      <div class="card-panel ms-category-add_item" @click="createCategory" v-if="isEditer">
        <h6 class="text-center">Создать новый подраздел...</h6>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState('menu', ['breadcrumbs', 'categories']),
      getCategoryChildren() {
    ...
    methods: {
      ...mapActions('menu', ['GET_CATEGORIES_BY_BREADCRUMBS']),
      ...
      createCategory() {
        ...
        this.$router.push({
          name: 'createCategory',
          params: {
            parentCategoryId: this.$route.params.categoryId,
