<template>
  <div class="row card-panel ms-category-item_create">
    ...
    <form ref="formCreate" @submit="submit" action="/Admin/Menu/Create/" method="post">
        ...
        <div class="file-field input-field col s12 m12">
          ...
          <div class="file-path-wrapper" style="flex-grow: 1">
            <input
              ...
              class="file-path"
              style="border: none; color: rgb(101, 147, 92)"
            />
          </div>
        </div>
        <div class="input-field col s12 m12">
      ...
      <div class="input-field m12">
        ...
        <button class="btn btn-defaultMainSite" v-bind:click.prevent="backToCategoryList">
          Назад
        </button>
      </div>
    </form>
